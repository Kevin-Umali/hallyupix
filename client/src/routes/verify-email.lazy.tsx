...
function CheckEmail() {
  ...
  const { mutate: sendVerificationEmailMutation, isPending } =
    ...
    >
      <CardHeader className="px-0 space-y-4">
        ...
        <CardDescription className="text-base leading-relaxed">
          ...
          <span className="font-semibold">{maskedEmail}</span>. Please check
          your inbox and follow the link to verify your account. If you don’t
          see the email, check your spam or junk folder.
          <br />
          <br />
          Verifying your email ensures your account is secure and unlocks all
          the features of {APP_NAME}.
        </CardDescription>
      </CardHeader>
