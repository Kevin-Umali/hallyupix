import { hc, InferRequestType, InferResponseType, ClientRequestOptions } from "hono/client";
...
export type ApiFunction<T> = (args: { json: T }, options?: ClientRequestOptions) => Promise<Response>;
